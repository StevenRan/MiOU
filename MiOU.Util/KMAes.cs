...
namespace KMBit.Util
{
    public class KMAes
    {
        ...
        public static string DecryptStringAES(string cipherText,string key= "8080808080808080")
        {
        ...
        public static string EncryptStringToBytes(string cipherText, string key = "8080808080808080")
        {
            var keybytes = Encoding.UTF8.GetBytes(key);
            var iv = Encoding.UTF8.GetBytes(key);
